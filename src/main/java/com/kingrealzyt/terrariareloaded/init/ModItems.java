...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> SILVER_BROADSWORD = ITEMS.register("silver_broadsword", () -> new SwordItem(ModItemTier., 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
