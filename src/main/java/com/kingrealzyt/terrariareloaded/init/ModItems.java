...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> CACTUS_SWORD = ITEMS.register("cactus_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> SILVER_SHORTSWORD = ITEMS.register("silver_shortsword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> EBONWOOD_SWORD = ITEMS.register("ebonwood_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> SHADEWOOD_SWORD = ITEMS.register("shadewood_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> GOLD_SHORTSWORD = ITEMS.register("gold_shortsword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> SILVER_BROADSWORD = ITEMS.register("silver_broadsword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BLADED_GLOVE = ITEMS.register("bladed_glove", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> ZOMBIE_ARM = ITEMS.register("zombie_arm", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> MANDIBLE_BLADE = ITEMS.register("mandible_blade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> STYLISH_SCISSORS = ITEMS.register("stylish_scissors", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> RULER = ITEMS.register("ruler", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> UMBRELLA = ITEMS.register("umbrella", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BREATHING_REED = ITEMS.register("breathing_reed", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> GLADIUS = ITEMS.register("gladius", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BONE_SWORD = ITEMS.register("bone_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> CANDY_CANE_SWORD = ITEMS.register("candy_cane_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> KATANA = ITEMS.register("katana", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> ICE_BLADE = ITEMS.register("ice_blade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> LIGHTS_BANE = ITEMS.register("lights_bane", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> TRAGIC_UMBRELLA = ITEMS.register("tragic_umbrella", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> MURAMASA = ITEMS.register("muramasa", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> TERRAGRIM = ITEMS.register("terragrim", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> EXOTIC_SCIMITAR = ITEMS.register("exotic_scimitar", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> YELLOW_PHASEBLADE = ITEMS.register("yellow_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> RED_PHASEBLADE = ITEMS.register("red_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> WHITE_PHASEBLADE = ITEMS.register("white_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> PURPLE_PHASEBLADE = ITEMS.register("purple_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> GREEN_PHASEBLADE = ITEMS.register("green_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BLUE_PHASEBLADE = ITEMS.register("blue_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> ORANGE_PHASEBLADE = ITEMS.register("orange_phaseblade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BLOOD_BUTCHERER = ITEMS.register("blood_butcherer", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> STARFURY = ITEMS.register("starfury", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> ENCHANTED_SWORD = ITEMS.register("enchanted_sword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> PURPLE_CLUBBERFISH = ITEMS.register("purple_clubberfish", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BEE_KEEPER = ITEMS.register("bee_keeper", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> FALCON_BLADE = ITEMS.register("falcon_blade", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> BLADE_OF_GRASS = ITEMS.register("blade_of_grass", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> FIERY_GREATSWORD = ITEMS.register("fiery_greatsword", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
    public static final RegistryObject<SwordItem> NIGHTS_EDGE = ITEMS.register("nights_edge", () -> new SwordItem(ModItemTier.COPPER_SHORT, 1, 0.0F, new Item.Properties().group(TerrariaReloaded.WEAPONS).setNoRepair()));
