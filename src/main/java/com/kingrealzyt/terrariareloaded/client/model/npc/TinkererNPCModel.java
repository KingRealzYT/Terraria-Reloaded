...
public class TinkererNPCModel<T extends TinkererNPCEntity> extends EntityModel<T> {
    ...
    public TinkererNPCModel() {
        ...
        armLeft.setTextureOffset(52, 12).addBox(-0.5F, 4.0F, -2.5F, 5.0F, 2.0F, 5.0F, 0.0F, false);

        head = new ModelRenderer(this);
        head.setRotationPoint(0.0F, 0.0F, 0.0F);
        head.setTextureOffset(0, 24).addBox(-4.0F, -7.75F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
        head.setTextureOffset(24, 0).addBox(-1.0F, -2.125F, -4.8125F, 2.0F, 1.0F, 1.0F, 0.0F, false);

        bone = new ModelRenderer(this);
        bone.setRotationPoint(0.0F, -7.5F, -4.0625F);
        head.addChild(bone);
        setRotationAngle(bone, -0.0349F, 0.0F, 0.0F);
        bone.setTextureOffset(40, 10).addBox(-4.0F, 2.3201F, -0.0162F, 8.0F, 4.0F, 0.0F, 0.0F, false);

        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(4.125F, -7.5F, -0.0625F);
        head.addChild(bone4);
        setRotationAngle(bone4, -0.0349F, -1.5708F, 0.0F);
        bone4.setTextureOffset(32, 44).addBox(-4.1875F, -0.8122F, -0.0196F, 8.0F, 8.0F, 0.0F, 0.0F, false);

        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(-4.125F, -7.5F, -0.3125F);
        head.addChild(bone5);
        setRotationAngle(bone5, -0.0349F, 1.5708F, 0.0F);
        bone5.setTextureOffset(32, 44).addBox(-4.0F, -0.8122F, -0.0196F, 8.0F, 8.0F, 0.0F, 0.0F, true);

        bone6 = new ModelRenderer(this);
        bone6.setRotationPoint(-5.0F, -3.5F, -0.25F);
        head.addChild(bone6);
        setRotationAngle(bone6, 0.1396F, -0.5498F, 0.0F);
        bone6.setTextureOffset(32, 19).addBox(0.0F, -2.8714F, -1.9478F, 0.0F, 5.0F, 4.0F, 0.0F, false);

        bone7 = new ModelRenderer(this);
        bone7.setRotationPoint(5.0F, -3.5F, -0.25F);
        head.addChild(bone7);
        setRotationAngle(bone7, 0.1396F, 0.5498F, 0.0F);
        bone7.setTextureOffset(32, 19).addBox(0.0F, -2.8714F, -1.9478F, 0.0F, 5.0F, 4.0F, 0.0F, true);
        ...
        bone9.setRotationPoint(0.0F, -0.25F, -2.0F);
        legLeft.addChild(bone9);
        setRotationAngle(bone9, -0.0349F, 0.0F, 0.0F);
        bone9.setTextureOffset(58, 46).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 8.0F, 0.0F, 0.0F, true);
        ...
        bone8.setRotationPoint(0.0F, -0.25F, -2.0F);
        legRight.addChild(bone8);
        setRotationAngle(bone8, -0.0349F, 0.0F, 0.0F);
        bone8.setTextureOffset(58, 46).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 8.0F, 0.0F, 0.0F, false);
        ...
        armRight.setTextureOffset(52, 12).addBox(-4.5F, 4.0F, -2.5F, 5.0F, 2.0F, 5.0F, 0.0F, false);
