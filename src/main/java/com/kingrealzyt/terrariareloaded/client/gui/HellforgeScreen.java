...
public class HellforgeScreen extends ContainerScreen<HellforgeContainer> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(TerrariaReloaded.MOD_ID,
            "textures/gui/hellforge.png");

    public HellforgeScreen(HellforgeContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.font.drawString(this.title.getFormattedText(), 8.0f, 8.0f, 0xffffff);
