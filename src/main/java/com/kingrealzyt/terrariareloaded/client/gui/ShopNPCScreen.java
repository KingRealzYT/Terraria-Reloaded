...
public class ShopNPCScreen extends MerchantScreen {
    ...
    private final ShopNPCScreen.TradeButton[] field_214138_m = new ShopNPCScreen.TradeButton[7];
    private int field_214139_n;
    private boolean field_214140_o;

    public ShopNPCScreen(MerchantContainer p_i51080_1_, PlayerInventory p_i51080_2_, ITextComponent p_i51080_3_) {
    ...
    protected void init() {
        ...
        for (int l = 0; l < 7; ++l) {
            this.field_214138_m[l] = this.addButton(new ShopNPCScreen.TradeButton(i + 5, k, l, (p_214132_1_) -> {
                if (p_214132_1_ instanceof ShopNPCScreen.TradeButton) {
                    this.selectedMerchantRecipe = ((ShopNPCScreen.TradeButton) p_214132_1_).func_212937_a() + this.field_214139_n;
                    this.func_195391_j();
                }
        ...
        if (!merchantoffers.isEmpty()) {
            ...
            for (MerchantOffer merchantoffer : merchantoffers) {
                if (this.func_214135_a(merchantoffers.size()) && (i1 < this.field_214139_n || i1 >= 7 + this.field_214139_n)) {
                    ...
                    int j1 = k + 2;
                    this.itemRenderer.renderItemOverlayIntoGUI(this.font, itemstack, l, j1, "" + itemstack.getCount());
            ...
            for (ShopNPCScreen.TradeButton merchantscreen$tradebutton : this.field_214138_m) {
    ...
    class TradeButton extends Button {
        ...
        public void renderToolTip(int p_renderToolTip_1_, int p_renderToolTip_2_) {
            if (this.isHovered && ShopNPCScreen.this.container.getOffers().size() > this.field_212938_a + ShopNPCScreen.this.field_214139_n) {
                if (p_renderToolTip_1_ < this.x + 20) {
                    ItemStack itemstack = ShopNPCScreen.this.container.getOffers().get(this.field_212938_a + ShopNPCScreen.this.field_214139_n).func_222205_b();
                    ShopNPCScreen.this.renderTooltip(itemstack, p_renderToolTip_1_, p_renderToolTip_2_);
                } else if (p_renderToolTip_1_ < this.x + 50 && p_renderToolTip_1_ > this.x + 30) {
                    ItemStack itemstack2 = ShopNPCScreen.this.container.getOffers().get(this.field_212938_a + ShopNPCScreen.this.field_214139_n).getBuyingStackSecond();
                    if (!itemstack2.isEmpty()) {
                        ShopNPCScreen.this.renderTooltip(itemstack2, p_renderToolTip_1_, p_renderToolTip_2_);
                    }
                } else if (p_renderToolTip_1_ > this.x + 65) {
                    ItemStack itemstack1 = ShopNPCScreen.this.container.getOffers().get(this.field_212938_a + ShopNPCScreen.this.field_214139_n).getSellingStack();
                    ShopNPCScreen.this.renderTooltip(itemstack1, p_renderToolTip_1_, p_renderToolTip_2_);
                }
            }
