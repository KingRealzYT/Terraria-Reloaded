	         ...
	         if (Minecraft.getInstance().world != null) {
	            ...
	            if (this.client.player != null) {
	               ...
	               if (world != null) {
	                     for(int x = -15; x < 15; ++x) {
	                        for(int y = -15; y < 15; ++y) {
	                           for(int z = -15; z < 15; ++z) {
	                              ...
	                              if (block == Blocks.SNOW || block == Blocks.ICE) {
	                                 ++snow;
	                              }

	                              if (block == ModBlocks.CORRUPT_GRASS_BLOCK) {
	                                 ++corruption;
	                              }

	                              if (block == ModBlocks.JUNGLE_GRASS_BLOCK) {
	                                 ++jungle;
	                              }
	                              ...
	                              if (block == Blocks.SAND && (new Vec3d((double)cameraPos.getX(), (double)cameraPos.getY(), (double)cameraPos.getZ())).distanceTo(new Vec3d(0.0D, (double)cameraPos.getY(), 0.0D)) < 4500.0D) {
	                                 ++desert;
	                              }

	                              if (block == Blocks.STONE  && Minecraft.getInstance().player.getPosY() <= 90.0D) {
	                                 ++cave;
	                              }
	                              
	                              if (block == ModBlocks.EBONSTONE) {
	                                 ++cave_corruption;
	                              }

	                              if (block == ModBlocks.ASH) {
	                                 ++underworld;
	                              }
	                              if (block == ModBlocks.CRIMSON_GRASS_BLOCK) {
	                            	  ++crimson;
	                              }
	                           }
	                        }
	                  ...
	                  if (cave > 15 && Minecraft.getInstance().player.getPosY() <= 45) {
