package com.kingrealzyt.terrariareloaded.client.renderer.entities.models;
...
@OnlyIn(Dist.CLIENT)
public class ModSlimeModel<T extends Entity> extends SegmentedModel<T> {
    ...
    public ModSlimeModel(int slimeBodyTexOffY) {
