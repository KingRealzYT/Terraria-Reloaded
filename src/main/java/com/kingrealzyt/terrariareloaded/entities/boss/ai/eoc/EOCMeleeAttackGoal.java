...
//Copied from the mc MeleeAttackGoal, and changed the entity. Because EOCEntity is not a CreatrueEntity
public class EOCMeleeAttackGoal extends Goal {
    protected final EOCEntity attacker;
    ...
    public EOCMeleeAttackGoal(EOCEntity creature, double speedIn, boolean useLongMemory) {
