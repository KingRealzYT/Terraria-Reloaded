...
public class BombEntity extends ProjectileItemEntity {
    ...
    public BombEntity(World worldIn, LivingEntity livingEntityIn) {
        super(ModEntityTypes.BOMB_ENTITY.get(), livingEntityIn, worldIn);
    }
    ...
    private void spawnItem(){
        ItemEntity item = new ItemEntity(this.world,
                ...
                new ItemStack(ModItems.BOMB_ITEM.get()));
