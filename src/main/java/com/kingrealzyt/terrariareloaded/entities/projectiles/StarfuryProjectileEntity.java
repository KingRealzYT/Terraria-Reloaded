...
public class StarfuryProjectileEntity extends ProjectileItemEntity {
    ...
    public StarfuryProjectileEntity(EntityType<? extends ProjectileItemEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public StarfuryProjectileEntity(World worldIn, LivingEntity livingEntityIn) {
