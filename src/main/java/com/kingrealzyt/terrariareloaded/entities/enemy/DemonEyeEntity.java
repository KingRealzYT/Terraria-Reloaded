...
public class DemonEyeEntity extends FlyingEntity{
    ...
    public DemonEyeEntity(EntityType<? extends DemonEyeEntity> type, World worldIn) {
        super(type, worldIn);
        init();
    }

    public DemonEyeEntity(World world) {
    ...
    public void init() {
        this.dataManager.set(DemonEyeEntity.type_data, rand.nextInt(6));
    }

    @Nullable
    public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {

        switch (this.dataManager.get(DemonEyeEntity.type_data).intValue()) {
            case 0:
    ...
    public static final DataParameter<Integer> type_data = EntityDataManager.createKey(DemonEyeEntity.class, DataSerializers.VARINT);
