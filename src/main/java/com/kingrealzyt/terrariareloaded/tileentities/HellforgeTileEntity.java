...
public class HellforgeTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {

    private ITextComponent customName;
    public int currentSmeltTime;
    public final int maxSmeltTime = 200;
    private HellforgeItemHandler inventory;

    public HellforgeTileEntity(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);

        this.inventory = new HellforgeItemHandler(2);
    }

    public HellforgeTileEntity() {
        this(ModTileEntityTypes.HELLFORGE.get());
    }

    @Override
    public Container createMenu(final int windowID, final PlayerInventory playerInv, final PlayerEntity playerIn) {
        return new HellforgeContainer(windowID, playerInv, this);
    }
    ...
    private ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + TerrariaReloaded.MOD_ID + ".hellforge");
    }
